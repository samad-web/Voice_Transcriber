 ...
 *
 * Seven tables with nothing in common but the two columns 0108 added, so the
...
export class RecycleBinController {
   ...
   * returning is the whole restore. See the 0108 header for why that is the
  ...
  async restore(
    ...
    return this.db.withOrg(orgId, async (client) => {
      ...
      try {
        ...
        // The mirror of what makes the bin work at all. 0108 made the name
