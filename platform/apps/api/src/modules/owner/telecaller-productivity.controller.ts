 ...
 * calls, read from the daily rollup (migration 0088).
 *
...
const SUMMARY_SQL = (scopeAnd: string) => `
  SELECT s.telecaller_id,
         ...
         -- of the rollup - see 0088's header.
         ...
         -- SOP adherence (0089), as scalar subqueries rather than a join.
         --
         ...
         --
         -- Ranged on call_started_at, never created_at: see 0089.
