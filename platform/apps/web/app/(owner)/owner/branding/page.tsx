...
import { getOwnerBranding, ownerGet } from "@/lib/owner-context";
 ...
 *
 * `branding` is one jsonb column on the org row, and any subset of the seven
  ...
  return (
    <>
      ...
      <p className="max-w-2xl text-sm text-text-muted">
        The images, colours and tab title used across this org&rsquo;s console. Images are links to
        files you already host &mdash; there is no upload here. Only the fields you change are sent,
        so anything you leave alone keeps its current value. Saved changes appear the next time a
        page loads.
      </p>
