...
/**
 * The recycle bin: what a tenant can delete and take back (migration 0097).
 *
 ...
 * to be gone. See the 0097 header for why both exist.
 */
...
export const RECYCLE_BIN: Record<RecycleBinResource, RecycleBinSpec> = {
  ...
  crm_integration: {
    ...
    // TypeScript is concerned. The end-to-end check in verify-0097 is what
 ...
 *
 * States the consequence first and the undo second. The whole point of 0097 is
